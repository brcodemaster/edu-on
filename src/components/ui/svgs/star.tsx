...
export const Star: React.FC<Props> = ({ width, height }) => {
	return (
		<span className={cn(width && `w-[${String(width)}px]`, height && `h-[${String(height)}px]`)}>
			<svg
				width={width || 16}
				height={height || 15}
				viewBox='0 0 16 15'
				...
				className={cn(width && height && 'w-full h-full object-contain')}
			>
				<path
