	...
	if (icon instanceof Object && 'src' in icon) {
		return (
			<Link
				href={link}
				className={cn(
					'w-[190px] h-[131px] border-[1px] border-gray-secondary rounded-3xl px-[50px] py-[18px] flex flex-col justify-center items-center hover:bg-blue-secondary/30 duration-300',
					disabled && 'grayscale'
				)}
			>
